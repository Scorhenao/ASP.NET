...
namespace ASPNET.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(AspnetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar, string filtro)
        {
            ...
            // Indicadores para alternar los iconos y rutas en la vista
            ViewData["Nombres"] = await _context.Usuarios
        .Select(u => u.Nombre)
        .Distinct()
        .OrderBy(n => n)
        .ToListAsync();

            ViewData["Fechas"] = await _context.Usuarios
                .Select(u => u.Fecha.Date)
                .Distinct()
                .OrderBy(f => f)
                .ToListAsync();
